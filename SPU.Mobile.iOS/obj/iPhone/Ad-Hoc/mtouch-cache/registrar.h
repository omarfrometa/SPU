...
@class Syncfusion_SfRotator_XForms_iOS_SfRotatorRenderer;
@class SfRotator;
@class Syncfusion_SfRotator_iOS_SFRotator;
@class Syncfusion_SfRotator_iOS_SfNavigationView;
@class Syncfusion_SfRotator_iOS_SfImageView;
@class Syncfusion_SfRotator_iOS_SfRotatorItem;
@class Syncfusion_SfRotator_iOS_SFRotatorItem;
...
@interface Syncfusion_SfRotator_XForms_iOS_SfRotatorRenderer : Xamarin_Forms_Platform_iOS_ViewRenderer_2 {
}
	-(id) init;
@end

@interface SfRotator : UIView {
}
	@property (nonatomic, assign) int DotsPlacement;
	@property (nonatomic, assign) int NavigationStripMode;
	@property (nonatomic, assign) int NavigationStripPosition;
	@property (nonatomic, assign) int NavigationDirection;
	...
	@property (nonatomic, assign) BOOL IsTextVisibile;
	@property (nonatomic, assign) NSInteger SelectedIndex;
	@property (nonatomic, assign) UIColor * DotsBorderColor;
	@property (nonatomic, assign) UIColor * SelectedDotsColor;
	@property (nonatomic, assign) UIColor * UnselectedDotsColor;
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
	-(void) xamarinSetGCHandle: (int) gchandle;
...
@interface Syncfusion_SfRotator_iOS_SFRotator : SfRotator {
}
	-(id) init;
@end

@interface Syncfusion_SfRotator_iOS_SfNavigationView : UIButton {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Syncfusion_SfRotator_iOS_SfImageView : UIView {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Syncfusion_SfRotator_iOS_SfRotatorItem : UIView {
}
	-(void) release;
	-(id) retain;
	-(int) xamarinGetGCHandle;
...
@interface Syncfusion_SfRotator_iOS_SFRotatorItem : Syncfusion_SfRotator_iOS_SfRotatorItem {
}
	-(id) init;
@end
