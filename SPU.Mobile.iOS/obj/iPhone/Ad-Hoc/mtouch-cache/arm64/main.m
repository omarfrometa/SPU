...
extern void *mono_aot_module_SPU_Mobile_iOS_info;
...
extern void *mono_aot_module_Syncfusion_SfRotator_XForms_iOS_info;
extern void *mono_aot_module_Syncfusion_SfRotator_XForms_info;
extern void *mono_aot_module_Syncfusion_SfRotator_iOS_info;
extern void *mono_aot_module_SPU_Mobile_info;
...
{
	mono_aot_register_module (mono_aot_module_SPU_Mobile_iOS_info);
	...
	mono_aot_register_module (mono_aot_module_Syncfusion_SfRotator_XForms_iOS_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_SfRotator_XForms_info);
	mono_aot_register_module (mono_aot_module_Syncfusion_SfRotator_iOS_info);
	mono_aot_register_module (mono_aot_module_SPU_Mobile_info);
...
void xamarin_register_assemblies_impl ()
{
	...
	xamarin_process_managed_exception_gchandle (exception_gchandle);
	xamarin_open_and_register ("Syncfusion.SfRotator.iOS.dll", &exception_gchandle);
	xamarin_process_managed_exception_gchandle (exception_gchandle);
