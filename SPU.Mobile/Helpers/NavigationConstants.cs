...
namespace SPU.Mobile.Helpers
{
    public static class NavigationConstants
    {
        ...
        public static string ClaimDetailsPage => "NavigationPage/ClaimDetailsPage";
        public static string ClaimResumePage => "ClaimResumePage";
        public static string CaptureSupportDocsPage => "NavigationPage/CaptureSupportDocsPage";
